...
Every Friday lecture (starting on Sep-6) I will use a shiny example, describing various aspects about its structure, and reviewing some of its key details. Every week we'll go over a different shiny app, increasing the level of complexity, but also making it more interactive and richer.
...
HW1 instructions will be released at the end of this week (due 09/13).
